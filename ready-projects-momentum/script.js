...
// Set Name
function setName(e) {
    if (e.type === "keypress" && name.textContent == "") {
        if (e.keyCode == 13) {
            name.textContent = "[Enter Name]";
            name.blur();
        }
...
// Get Focus
function getFocus() {
    if (localStorage.getItem("focus") === "" || !localStorage.getItem("focus")) {
...
// Set Focus
function setFocus(e) {
    if (e.type === "keypress" && focus.textContent == "") {
        if (e.keyCode == 13) {
            focus.textContent = "[Enter Focus]";
            focus.blur();
        }
...
function ChangeBg() {
    ...
    setTimeout(function() { change.disabled = false }, 1500)
